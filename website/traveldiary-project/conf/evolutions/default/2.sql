...
INSERT INTO activityreview VALUES(10,4,'review10','review description10',strftime('%Y-%m-%d %H:%M:%f','now'),2,2);

INSERT INTO vacationreview VALUES(11,3,'review11','review description11',strftime('%Y-%m-%d %H:%M:%f','now'),3,3);
INSERT INTO vacationreview VALUES(12,4,'review12','review description12',strftime('%Y-%m-%d %H:%M:%f','now'),4,3);
